...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _regenerator=__webpack_require__(10);var _regenerator2=_interopRequireDefault(_regenerator);var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(0);var _react2=_interopRequireDefault(_react);var _reactRedux=__webpack_require__(19);var _network=__webpack_require__(1055);var _i18n=__webpack_require__(13);var _loaders=__webpack_require__(25);var _reactIntl=__webpack_require__(11);var _lodash=__webpack_require__(17);var _lodash2=_interopRequireDefault(_lodash);var _Links=__webpack_require__(23);var _constants=__webpack_require__(22);var _RingPieChart=__webpack_require__(2450);var _reactRouterDom=__webpack_require__(28);var _api=__webpack_require__(14);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{return Promise.resolve(value).then(function(value){step("next",value);},function(err){step("throw",err);});}}return step("next");});};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Representatives=function(_Component){_inherits(Representatives,_Component);function Representatives(){var _this2=this;_classCallCheck(this,Representatives);var _this=_possibleConstructorReturn(this,(Representatives.__proto__||Object.getPrototypeOf(Representatives)).call(this));_this.getLatestBlock=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee(){var latestBlock;return _regenerator2.default.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return _api.Client.getLatestBlock();case 2:latestBlock=_context.sent;_this.setState({latestBlock:latestBlock.number});case 4:case"end":return _context.stop();}}},_callee,_this2);}));_this.state={latestBlock:''};return _this;}_createClass(Representatives,[{key:"componentDidMount",value:function componentDidMount(){this.props.loadWitnesses();this.props.loadStatisticData();this.getLatestBlock();}},{key:"getPiechart",value:function getPiechart(){var intl=this.props.intl;var statisticData=this.props.statisticData;var pieChartData=[];if(statisticData.length>0){statisticData.map(function(val,i){pieChartData.push({key:i+1,name:val.name?val.name:val.url,volumeValue:intl.formatNumber(val.blockProduced),volumePercentage:intl.formatNumber(val.percentage*100,{maximumFractionDigits:2,minimumFractionDigits:2})+'%'});});}return pieChartData;}},{key:"renderWitnesses",value:function renderWitnesses(witnesses){var _this3=this;var latestBlock=this.state.latestBlock;if(witnesses.length===0){return _react2.default.createElement("div",{className:"card"},_react2.default.createElement(_loaders.TronLoader,null,(0,_i18n.tu)("loading_representatives")));}var superRepresentatives=(0,_lodash.sortBy)((0,_lodash.filter)(witnesses,function(w){return w.producer;}),function(w){return w.votes*-1;});var candidateRepresentatives=(0,_lodash.sortBy)((0,_lodash.filter)(witnesses,function(w){return!w.producer;}),function(w){return w.votes*-1;});superRepresentatives.map(function(account){Number(latestBlock)-account.latestBlockNumber<1000?account.representerStatus=true:account.representerStatus=false;});return _react2.default.createElement("div",{className:"card border-0 represent__table w-1000"},_react2.default.createElement("table",{className:"table table-hover table-striped bg-white m-0 sr",style:{border:'1px solid #DFD7CA'}},_react2.default.createElement("thead",{className:"thead-dark"},_react2.default.createElement("tr",null,_react2.default.createElement("th",{className:"text-center"},"#"),_react2.default.createElement("th",null,(0,_i18n.tu)("name")),_react2.default.createElement("th",{className:"text-center text-nowrap"},(0,_i18n.tu)("status")),_react2.default.createElement("th",{className:"text-center text-nowrap d-none d-lg-table-cell"},(0,_i18n.tu)("last_block")),_react2.default.createElement("th",{className:"text-center text-nowrap d-none d-lg-table-cell"},(0,_i18n.tu)("blocks_produced")),_react2.default.createElement("th",{className:"text-center text-nowrap d-none d-lg-table-cell"},(0,_i18n.tu)("blocks_missed")),_react2.default.createElement("th",{className:"text-center text-nowrap"},(0,_i18n.tu)("productivity")),_react2.default.createElement("th",{className:"text-right text-nowrap",style:{borderRight:'1px solid rgb(223, 215, 202)'}},(0,_i18n.tu)("votes")))),_react2.default.createElement("tbody",null,_react2.default.createElement("tr",{style:{height:'72px'}},_react2.default.createElement("td",{colSpan:"9",className:"font-weight-bold"},_react2.default.createElement("i",{className:"fa fa-trophy mr-2 ml-2","aria-hidden":"true",style:{color:'#666'}}),(0,_i18n.tu)("Super Representatives"))),superRepresentatives.map(function(account,index){return _react2.default.createElement(Row,{index:index,state:_this3.state,props:_this3.props,key:account.address,account:account});}),_react2.default.createElement("tr",{style:{height:'72px'}},_react2.default.createElement("td",{colSpan:"9",className:"font-weight-bold"},_react2.default.createElement("i",{className:"fa fa-user mr-2 ml-2","aria-hidden":"true",style:{color:'#666'}}),(0,_i18n.tu)("Super Representative Candidates"))),candidateRepresentatives.map(function(account,index){return _react2.default.createElement(Row,{index:index+27,state:_this3.state,props:_this3.props,key:account.address,account:account,showSync:false});}))));}},{key:"render",value:function render(){var _props=this.props,intl=_props.intl,witnesses=_props.witnesses;var pieChart=this.getPiechart();var productivityWitnesses=witnesses.slice(0,_constants.SR_MAX_COUNT);var mostProductive=(0,_lodash.sortBy)(productivityWitnesses,function(w){return w.producePercentage*-1;})[0];var leastProductive=(0,_lodash2.default)(productivityWitnesses).filter(function(w){return w.producedTotal>0;}).sortBy(function(w){return w.producePercentage;}).value()[0];return _react2.default.createElement("main",{className:"container header-overlap pb-3 token_black"},_react2.default.createElement("div",{className:witnesses.length===0||pieChart.length===0?'card':''},witnesses.length===0||pieChart.length===0?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement("div",{className:"row"},_react2.default.createElement("div",{className:"col-md-6 foundation_title represent_title"},_react2.default.createElement("div",{className:"mb-3"},_react2.default.createElement("div",{className:"card h-100 widget-icon"},_react2.default.createElement("div",{className:"card-body"},_react2.default.createElement("h3",{className:"text-primary"},_react2.default.createElement(_reactIntl.FormattedNumber,{value:witnesses.length})),(0,_i18n.tu)("representativesAcandidates")))),_react2.default.createElement("div",{className:"mb-3"},_react2.default.createElement("div",{className:"card h-100"},_react2.default.createElement("div",{className:"card-body"},_react2.default.createElement("h3",null,_react2.default.createElement(_reactIntl.FormattedNumber,{value:mostProductive.producePercentage}),"%"),_react2.default.createElement("div",{className:"represent_title_text"},_react2.default.createElement("span",null,(0,_i18n.tu)("highest_productivity")," - "),_react2.default.createElement(_Links.AddressLink,{address:mostProductive.address},mostProductive.name||mostProductive.url))))),_react2.default.createElement("div",{className:"mb-3"},_react2.default.createElement("div",{className:"card h-100 widget-icon"},_react2.default.createElement("div",{className:"card-body"},_react2.default.createElement("h3",null,_react2.default.createElement(_reactIntl.FormattedNumber,{maximumFractionDigits:2,minimunFractionDigits:2,value:leastProductive.producePercentage}),"%"),_react2.default.createElement("div",{className:"represent_title_text"},_react2.default.createElement("span",null,(0,_i18n.tu)("lowest_productivity")," - "),_react2.default.createElement(_Links.AddressLink,{address:leastProductive.address},leastProductive.name||leastProductive.url)))))),_react2.default.createElement("div",{className:"col-md-6 mb-3"},_react2.default.createElement("div",{className:"card"},_react2.default.createElement("div",{style:{height:326,background:'#fff'},className:"pt-2 bg-line_blue"},_react2.default.createElement("div",{className:"card-header bg-tron-light color-grey-100 text-center pb-0",style:{border:0}},_react2.default.createElement("h6",{className:"m-0 lh-150",style:{fontSize:16}},_react2.default.createElement(_reactRouterDom.Link,{to:"/blockchain/stats/pieChart"},(0,_i18n.tu)("produce_distribution")))),_react2.default.createElement("div",{className:"card-body pt-0"},_react2.default.createElement("div",{style:{minWidth:255,height:200}},_react2.default.createElement(_RingPieChart.RepresentativesRingPieReact,{message:{id:'produce_distribution'},intl:intl,data:pieChart,style:{height:255},source:"representatives"})))))))),_react2.default.createElement("div",{className:" mt-3"},_react2.default.createElement("div",{className:" table-scroll"},this.renderWitnesses(witnesses))));}}]);return Representatives;}(_react.Component);function Row(_ref2){var account=_ref2.account,_ref2$showSync=_ref2.showSync,showSync=_ref2$showSync===undefined?true:_ref2$showSync,index=_ref2.index,state=_ref2.state,props=_ref2.props;return _react2.default.createElement("tr",{key:account.address,className:account.index>26?'represent__table__lighter':'represent__table__content'},_react2.default.createElement("td",{className:"text-center",style:{paddingLeft:'14px'}},index+1),_react2.default.createElement("td",null,account.name?_react2.default.createElement("div",{className:"_context_right_click",style:{width:'200px'}},_react2.default.createElement(_Links.AddressLink,{address:account.address},account.name,_react2.default.createElement("br",null),_react2.default.createElement("span",{className:"small text-muted"},account.url))):_react2.default.createElement("div",{className:"_context_right_click"},_react2.default.createElement(_Links.AddressLink,{address:account.address},account.url))),showSync?_react2.default.createElement("td",{className:"text-center"},account.representerStatus?_react2.default.createElement("span",{key:"no",className:"text-success"},_react2.default.createElement("i",{className:"fas fa-circle"})):_react2.default.createElement("span",{key:"yes",className:"text-danger"},_react2.default.createElement("i",{className:"fa fa-times"}))):_react2.default.createElement("td",null,"\xA0"),_react2.default.createElement("td",{className:"text-center  d-none d-lg-table-cell"},account.latestBlockNumber?_react2.default.createElement(_Links.BlockNumberLink,{number:account.latestBlockNumber}):'-'),_react2.default.createElement("td",{className:"text-center d-none d-lg-table-cell"},account.producedTotal?_react2.default.createElement(_reactIntl.FormattedNumber,{value:account.producedTotal}):'-'),_react2.default.createElement("td",{className:"text-center d-none d-lg-table-cell"},account.missedTotal!==0?_react2.default.createElement(_reactIntl.FormattedNumber,{value:account.missedTotal}):'-'),_react2.default.createElement("td",{className:"text-center"},account.producedTotal>0?_react2.default.createElement(_react.Fragment,null,Math.floor(account.producePercentage*100)/100,"%"):'-'),_react2.default.createElement("td",{className:"text-right"},_react2.default.createElement(_react.Fragment,null,_react2.default.createElement(_reactIntl.FormattedNumber,{value:account.votes||0}),_react2.default.createElement("br",null),'(',_react2.default.createElement(_reactIntl.FormattedNumber,{minimumFractionDigits:2,maximumFractionDigits:2,value:account.votesPercentage}),"%",')')));}function mapStateToProps(state){return{witnesses:state.network.witnesses,statisticData:state.network.statisticData};}var mapDispatchToProps={loadWitnesses:_network.loadWitnesses,loadStatisticData:_network.loadStatisticData};exports.default=(0,_reactRedux.connect)(mapStateToProps,mapDispatchToProps,null,{pure:false})((0,_reactIntl.injectIntl)(Representatives));//export default connect(mapStateToProps, mapDispatchToProps)(Representatives)
...
//# sourceMappingURL=Representatives.e90a9fd9.chunk.js.map
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _regenerator=__webpack_require__(10);var _regenerator2=_interopRequireDefault(_regenerator);var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(0);var _react2=_interopRequireDefault(_react);var _reactIntl=__webpack_require__(11);var _reactRedux=__webpack_require__(19);var _markets=__webpack_require__(444);var _MarketOverview=__webpack_require__(2650);var _MarketOverview2=_interopRequireDefault(_MarketOverview);var _loaders=__webpack_require__(25);var _api=__webpack_require__(14);var _RingPieChart=__webpack_require__(2450);var _reactRouterDom=__webpack_require__(28);var _i18n=__webpack_require__(13);var _LineCharts=__webpack_require__(228);var _index=__webpack_require__(30);var _index2=_interopRequireDefault(_index);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{return Promise.resolve(value).then(function(value){step("next",value);},function(err){step("throw",err);});}}return step("next");});};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Markets=function(_React$Component){_inherits(Markets,_React$Component);function Markets(){var _this2=this;_classCallCheck(this,Markets);var _this=_possibleConstructorReturn(this,(Markets.__proto__||Object.getPrototypeOf(Markets)).call(this));_this.loadMarketData=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee(){var intl,markets,today,timerToday,birthday,timerBirthday,dayNum,_ref2,data,priceStatsTemp,volumeData,volumeUSD,volume;return _regenerator2.default.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:intl=_this.props.intl;_this.props.loadPriceData();_context.next=4;return _api.Client.getMarkets();case 4:markets=_context.sent;today=new Date();timerToday=today.getTime();birthday=new Date("2017/10/10");timerBirthday=birthday.getTime();dayNum=Math.floor((timerToday-timerBirthday)/1000/3600/24);_context.next=12;return _index2.default.get("https://min-api.cryptocompare.com/data/histoday?fsym=TRX&tsym=USD&limit="+dayNum);case 12:_ref2=_context.sent;data=_ref2.data;priceStatsTemp=data['Data'];_context.next=17;return _index2.default.get("https://server.tron.network/api/v2/node/market_data");case 17:volumeData=_context.sent;volumeUSD=volumeData.data.market_cap_by_available_supply;volume=volumeUSD.map(function(v,i){return{time:v[0],volume_billion:v[1]/Math.pow(10,9),volume_usd:intl.formatNumber(v[1])+' USD'};});_this.setState({markets:markets,priceStats:priceStatsTemp,volume:volume.slice(27,volume.length-1)});case 21:case"end":return _context.stop();}}},_callee,_this2);}));_this.formatTableData=function(markets){var intl=_this.props.intl;var data=[];markets.sort(function(a,b){return a.rank-b.rank;});if(markets.length){markets.map(function(val){data.push({key:val.rank,rank:val.rank,name:val.name,pair:val.pair,volumeNative:intl.formatNumber(val.volumeNative)+' TRX',volumePercentage:intl.formatNumber(val.volumePercentage,{maximumFractionDigits:2,minimumFractionDigits:2})+'%'!=='0.00%'?intl.formatNumber(val.volumePercentage,{maximumFractionDigits:2,minimumFractionDigits:2})+'%':'-',price:'$'+intl.formatNumber(val.price,{maximumFractionDigits:4})});});}return data.slice(0,99);};_this.customizedColumn=function(){var intl=_this.props.intl;var column=[{title:intl.formatMessage({id:'rank'}),dataIndex:'rank',key:'rank',sorter:true,width:'5%',className:'ant_table'},{title:intl.formatMessage({id:'exchange'}),dataIndex:'name',key:'name',filterDropdown:true},{title:intl.formatMessage({id:'pair'}),dataIndex:'pair',key:'pair',width:'12%'},{title:intl.formatMessage({id:'volume'}),dataIndex:'volumeNative',key:'volumeNative',width:'14%'},{title:'%',dataIndex:'volumePercentage',key:'volumePercentage',width:'8%'},{title:intl.formatMessage({id:'price'}),dataIndex:'price',key:'price',width:'10%'}];return column;};_this.state={priceGraph:[],volumeGraph:[],markets:[],priceStats:null,volume:null};return _this;}_createClass(Markets,[{key:"componentDidMount",value:function componentDidMount(){this.loadMarketData();}},{key:"render",value:function render(){var _props=this.props,intl=_props.intl,priceGraph=_props.priceGraph,volumeGraph=_props.volumeGraph;var _state=this.state,markets=_state.markets,priceStats=_state.priceStats,volume=_state.volume;var tableData=this.formatTableData(markets);var column=this.customizedColumn();return _react2.default.createElement("main",{className:"container header-overlap pb-3"},_react2.default.createElement("div",{className:"row"},_react2.default.createElement("div",{className:"col-md-6 mt-3 mt-md-0 "},_react2.default.createElement("div",{className:"card",style:styles.card},_react2.default.createElement("div",{className:"card-header bg-tron-light color-grey-100 text-center pb-0",style:styles.card},_react2.default.createElement("h5",{className:"m-0 lh-150"},_react2.default.createElement(_reactRouterDom.Link,{to:"blockchain/stats/priceStats"},(0,_i18n.tu)("average_price")))),_react2.default.createElement("div",{className:"card-body pt-0",style:{paddingLeft:'2rem',paddingRight:'2rem'}},_react2.default.createElement("div",{style:{minWidth:255,height:200}},priceStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartPrice,{style:{minWidth:255,height:200},data:priceStats,intl:intl,source:"markets"}))))),_react2.default.createElement("div",{className:"col-md-6 mt-3 mt-md-0 "},_react2.default.createElement("div",{className:"card",style:styles.card},_react2.default.createElement("div",{className:"card-header bg-tron-light color-grey-100 text-center pb-0",style:styles.card},_react2.default.createElement("h5",{className:"m-0 lh-150"},_react2.default.createElement(_reactRouterDom.Link,{to:"blockchain/stats/volumeStats"},(0,_i18n.tu)("volume_24")))),_react2.default.createElement("div",{className:"card-body pt-0",style:{paddingLeft:'2rem',paddingRight:'2rem'}},_react2.default.createElement("div",{style:{minWidth:255,height:200}},volume===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartVolumeUsd,{style:{minWidth:255,height:200},data:volume,intl:intl,source:"markets"})))))),_react2.default.createElement("div",{className:"row mt-3"},_react2.default.createElement("div",{className:"col-md-12"},_react2.default.createElement("div",{className:"card",style:styles.card},_react2.default.createElement("div",{className:"card-body"},_react2.default.createElement(_RingPieChart.RingPieReact,{message:{id:'Trade Volume'},style:{height:700},data:markets,intl:intl}))))),_react2.default.createElement("div",{className:"row mt-3"},_react2.default.createElement("div",{className:"col-md-12"},_react2.default.createElement(_MarketOverview2.default,{tableData:tableData,column:column}))));}}]);return Markets;}(_react2.default.Component);var styles={list:{fontSize:18},card:{border:'none',borderRadius:0}};function mapStateToProps(state){return{priceGraph:state.markets.price,volumeGraph:state.markets.volume};}var mapDispatchToProps={loadPriceData:_markets.loadPriceData};exports.default=(0,_reactRedux.connect)(mapStateToProps,mapDispatchToProps,null,{pure:false})((0,_reactIntl.injectIntl)(Markets));
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports.default=undefined;var _table=__webpack_require__(68);var _table2=_interopRequireDefault(_table);var _icon=__webpack_require__(18);var _icon2=_interopRequireDefault(_icon);var _button=__webpack_require__(84);var _button2=_interopRequireDefault(_button);var _input=__webpack_require__(85);var _input2=_interopRequireDefault(_input);var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();__webpack_require__(77);__webpack_require__(187);__webpack_require__(129);__webpack_require__(111);var _react=__webpack_require__(0);var _react2=_interopRequireDefault(_react);var _i18n=__webpack_require__(13);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var MarketOverview=function(_Component){_inherits(MarketOverview,_Component);function MarketOverview(){_classCallCheck(this,MarketOverview);var _this=_possibleConstructorReturn(this,(MarketOverview.__proto__||Object.getPrototypeOf(MarketOverview)).call(this));_this.onInputChange=function(e){_this.setState({searchText:e.target.value});};_this.onReset=function(){_this.setState({searchText:''},function(){_this.onSearch();});};_this.onSearch=function(){var tableData=_this.props.tableData;var searchText=_this.state.searchText;var reg=new RegExp(searchText,'gi');_this.setState({filterDropdownVisible:false,filtered:!!searchText,data:tableData.map(function(record){var match=record.name.match(reg);if(!match){return null;}return _extends({},record,{name:_react2.default.createElement("span",null,record.name.split(new RegExp("("+searchText+")",'i')).map(function(text,i){return text.toLowerCase()===searchText.toLowerCase()?_react2.default.createElement("span",{key:i,className:"highlight"},text):text// eslint-disable-line
;}))});}).filter(function(record){return!!record;})});};_this.setColumn=function(column){function compare(property){return function(obj1,obj2){if(obj1[property]>obj2[property]){return 1;}else if(obj1[property]<obj2[property]){return-1;}else{return 0;}};}var filter={filterDropdown:_react2.default.createElement("div",{className:"custom-filter-dropdown"},_react2.default.createElement(_input2.default,{ref:function ref(ele){return _this.searchInput=ele;},placeholder:"Search name",value:_this.state.searchText,onChange:_this.onInputChange,onPressEnter:_this.onSearch}),_react2.default.createElement(_button2.default,{type:"primary",onClick:_this.onSearch},(0,_i18n.tu)("search")),_react2.default.createElement(_button2.default,{className:"btn-secondary ml-1",onClick:_this.onReset},(0,_i18n.tu)("reset"))),filterIcon:_react2.default.createElement(_icon2.default,{type:"filter",style:{color:_this.state.filtered?'#108ee9':'#aaa'}}),filterDropdownVisible:_this.state.filterDropdownVisible,onFilterDropdownVisibleChange:function onFilterDropdownVisibleChange(visible){_this.setState({filterDropdownVisible:visible},function(){_this.searchInput&&_this.searchInput.focus();});}};var columns=[];var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=column[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var col=_step.value;if(col.sorter&&!col.filterDropdown){var temp={sorter:compare(col.key)};columns.push(_extends({},col,temp));}else if(!col.sorter&&col.filterDropdown){var _temp=_extends({},filter);columns.push(_extends({},col,_temp));}else if(col.sorter&&col.filterDropdown){var _temp2=_extends({sorter:compare(col.key)},filter);columns.push(_extends({},col,_temp2));}else{columns.push(col);}}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}return columns;};_this.state={markets:[],filterDropdownVisible:false,data:[],columns:[],searchText:'',filtered:false};return _this;}_createClass(MarketOverview,[{key:"componentDidMount",value:function componentDidMount(){}},{key:"render",value:function render(){var column=this.props.column;var columns=this.setColumn(column);var tableData=this.props.tableData;var data=this.state.data;if(data.length){tableData=this.state.data;}return _react2.default.createElement("div",{className:"card token_black markets"},_react2.default.createElement(_table2.default,{columns:columns,dataSource:tableData}));}}]);return MarketOverview;}(_react.Component);exports.default=MarketOverview;

/***/ })

});
//# sourceMappingURL=Markets.a2beaf64.chunk.js.map
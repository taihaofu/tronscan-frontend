...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _datePicker=__webpack_require__(131);var _datePicker2=_interopRequireDefault(_datePicker);var _regenerator=__webpack_require__(10);var _regenerator2=_interopRequireDefault(_regenerator);var _select=__webpack_require__(112);var _select2=_interopRequireDefault(_select);var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();__webpack_require__(157);__webpack_require__(230);var _react=__webpack_require__(0);var _react2=_interopRequireDefault(_react);var _index=__webpack_require__(30);var _index2=_interopRequireDefault(_index);var _api=__webpack_require__(14);var _constants=__webpack_require__(22);var _reactRedux=__webpack_require__(19);var _reactIntl=__webpack_require__(11);var _lodash=__webpack_require__(17);var _tron=__webpack_require__(222);var _loaders=__webpack_require__(25);var _PieChart=__webpack_require__(1072);var _PieChart2=_interopRequireDefault(_PieChart);var _LineChart=__webpack_require__(1059);var _LineChart2=_interopRequireDefault(_LineChart);var _i18n=__webpack_require__(13);var _reactCountup=__webpack_require__(455);var _reactCountup2=_interopRequireDefault(_reactCountup);var _reactRouterDom=__webpack_require__(28);var _SmartTable=__webpack_require__(50);var _SmartTable2=_interopRequireDefault(_SmartTable);var _moment=__webpack_require__(21);var _moment2=_interopRequireDefault(_moment);var _Links=__webpack_require__(23);var _text=__webpack_require__(41);var _isMobile=__webpack_require__(155);var _isMobile2=_interopRequireDefault(_isMobile);var _LineCharts=__webpack_require__(228);var _RingPieChart=__webpack_require__(2450);var _markets=__webpack_require__(444);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{return Promise.resolve(value).then(function(value){step("next",value);},function(err){step("throw",err);});}}return step("next");});};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Option=_select2.default.Option;// const API_URL = 'http://52.15.68.74:10000'
var Statistics=function(_React$Component){_inherits(Statistics,_React$Component);function Statistics(){var _this2=this;_classCallCheck(this,Statistics);var _this=_possibleConstructorReturn(this,(Statistics.__proto__||Object.getPrototypeOf(Statistics)).call(this));_this.loadTotalTRXSupply=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee(){var intl,_ref2,funds,supplyTypesChartData,trxPriceData,priceUSD,priceBTC,marketCapitalization;return _regenerator2.default.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:intl=_this.props.intl;_context.next=3;return _api.Client.getFundsSupply();case 3:_ref2=_context.sent;funds=_ref2.funds;supplyTypesChartData=[{value:funds.turnOver,name:'circulating_supply',selected:true,sliced:true},{value:funds.fundTrx,name:'total_frozen',selected:false,sliced:false}];_context.next=8;return _index2.default.get("https://api.coinmarketcap.com/v1/ticker/tronix/?convert=EUR");case 8:trxPriceData=_context.sent;priceUSD=(parseFloat(trxPriceData.data[0].price_usd)*1000).toFixed(2);priceBTC=(parseFloat(trxPriceData.data[0].price_btc)*1000).toFixed(5);marketCapitalization=(parseFloat(trxPriceData.data[0].price_usd)*funds.totalTurnOver).toFixed(2);_this.setState({supplyTypesChart:supplyTypesChartData,genesisNum:intl.formatNumber(funds.genesisBlockIssue),blockProduceRewardsNum:intl.formatNumber(funds.totalBlockPay),nodeRewardsNum:intl.formatNumber(funds.totalNodePay),independenceDayBurned:intl.formatNumber(funds.burnPerDay),feeBurnedNum:intl.formatNumber(funds.burnByCharge),currentTotalSupply:funds.totalTurnOver,priceUSD:priceUSD,priceBTC:priceBTC,marketCapitalization:marketCapitalization,foundationFreeze:intl.formatNumber(funds.fundTrx),circulatingNum:intl.formatNumber(funds.turnOver)});case 13:case"end":return _context.stop();}}},_callee,_this2);}));_this.onChangeDate=function(date,dateString){var match=_this.props.match;var chartName=match.params.chartName;_this.setState({ContractInvocationDistributionParams:_extends({},_this.state.ContractInvocationDistributionParams,{time:date.valueOf()})},function(){switch(chartName){case'ContractInvocationDistribution':_this.loadContractInvocationDistribution();break;case'EnergyConsumeDistribution':_this.loadEnergyConsumeDistribution();break;}});};_this.handleChangeSelect=function(value){var match=_this.props.match;var chartName=match.params.chartName;var map={20:'Top20',50:'Top50',100:'Top100'};_this.setState({ContractInvocationDistributionParams:_extends({},_this.state.ContractInvocationDistributionParams,{range:value,range_type:map[value]})},function(){switch(chartName){case'ContractInvocationDistribution':_this.loadContractInvocationDistribution();break;case'EnergyConsumeDistribution':_this.loadEnergyConsumeDistribution();break;}});};_this.disabledEndDate=function(endValue){var startValue=new Date()-2*24*60*60*1000;if(!endValue||!startValue){return false;}return endValue.valueOf()>=startValue.valueOf();};_this.customizedColumn=function(){var intl=_this.props.intl;var column=[{title:"#",dataIndex:'index',key:'index',width:'40px',align:'center',render:function render(text,record,index){return _react2.default.createElement("span",null,text);}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'contract_address'})),dataIndex:'contract_address',key:'contract_address',render:function render(text,record,index){return _react2.default.createElement(_Links.AddressLink,{address:text,isContract:true});}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'contract_name'})),dataIndex:'name',key:'name',render:function render(text,record,index){return _react2.default.createElement("span",null,text||'-');}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'total_energy_used'})),dataIndex:'total_energy',key:'total_energy',render:function render(text,record,index){return _react2.default.createElement(_reactIntl.FormattedNumber,{value:text});}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'freezing_energy'})),dataIndex:'energy',key:'energy',render:function render(text,record,index){return _react2.default.createElement(_reactIntl.FormattedNumber,{value:text});}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'burning_energy'})),dataIndex:'trx',key:'trx',render:function render(text,record,index){return _react2.default.createElement(_reactIntl.FormattedNumber,{value:text});}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'energy_scale'})),dataIndex:'percent',key:'percent',render:function render(text,record,index){return _react2.default.createElement("span",null,text);}}];return column;};_this.callCustomizedColumn=function(){var intl=_this.props.intl;var column=[{title:"#",dataIndex:'index',key:'index',width:'40px',align:'center',render:function render(text,record,index){return _react2.default.createElement("span",null,text);}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'contract_address'})),dataIndex:'contract_address',key:'contract_address',render:function render(text,record,index){return _react2.default.createElement(_Links.AddressLink,{address:text});}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'contract_name'})),dataIndex:'name',key:'name',render:function render(text,record,index){return _react2.default.createElement("span",null,text||'-');}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'call_address_time'})),dataIndex:'caller_amount',key:'caller_amount',render:function render(text,record,index){return _react2.default.createElement(_reactIntl.FormattedNumber,{value:text});}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'call_time'})),dataIndex:'trigger_amount',key:'trigger_amount',render:function render(text,record,index){return _react2.default.createElement(_reactIntl.FormattedNumber,{value:text});}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'call_address_scale'})),dataIndex:'caller_percent',key:'caller_percent',render:function render(text,record,index){return _react2.default.createElement("span",null,text);}},{title:(0,_lodash.upperFirst)(intl.formatMessage({id:'call_scale'})),dataIndex:'trigger_percent',key:'trigger_percent',render:function render(text,record,index){return _react2.default.createElement("span",null,text);}}];return column;};_this.state={accounts:null,transactionStats:null,blockStats:null,transactionValueStats:null,txOverviewStats:null,txOverviewStatsFull:null,addressesStats:null,blockSizeStats:null,blockchainSizeStats:null,priceStats:null,volumeStats:null,summit:null,pieChart:null,supplyTypesChart:null,genesisNum:null,blockProduceRewardsNum:null,nodeRewardsNum:null,independenceDayBurned:null,feeBurnedNum:null,currentTotalSupply:null,priceUSD:null,priceBTC:null,marketCapitalization:null,foundationFreeze:null,circulatingNum:null,energyConsumeData:null,ContractInvocation:null,ContractInvocationDistribution:null,ContractInvocationDistributionParams:{time:new Date().getTime()-2*24*60*60*1000,range:20,total_used_energy:0,scale:'',range_type:'Top20'},EnergyConsumeDistribution:null};return _this;}_createClass(Statistics,[{key:"componentDidMount",value:function componentDidMount(){var _this3=this;var match=this.props.match;var chartName=match.params.chartName;switch(chartName){case'supply':this.loadTotalTRXSupply();setInterval(function(){_this3.loadTotalTRXSupply();},30000);break;case'pieChart':this.loadPieChart();break;case'volumeStats':this.loadVolume();break;case'priceStats':this.loadPriceStats();break;case'accounts':this.loadAccounts();break;case'EnergyConsume':this.loadEnergyConsumeData();break;case'ContractInvocation':this.loadContractInvocation();break;case'ContractInvocationDistribution':this.loadContractInvocationDistribution();break;case'EnergyConsumeDistribution':this.loadEnergyConsumeDistribution();break;default:this.loadTxOverviewStats();break;}}},{key:"compare",value:function compare(property){return function(obj1,obj2){if(obj1[property]>obj2[property]){return 1;}else if(obj1[property]<obj2[property]){return-1;}else{return 0;}};}},{key:"loadAccounts",value:function(){var _ref3=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee2(){var accountData,accounts;return _regenerator2.default.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return _index2.default.get("https://assistapi.tronscan.org/api/account?limit=35&sort=-balance");case 2:accountData=_context2.sent;accounts=accountData.data;this.setState({accounts:(0,_lodash.filter)(accounts,function(account){return!(0,_lodash.includes)(_tron.tronAddresses,account.address);}).slice(0,10).map(function(account){return{name:account.address,value:account.balance/_constants.ONE_TRX};})});case 5:case"end":return _context2.stop();}}},_callee2,this);}));function loadAccounts(){return _ref3.apply(this,arguments);}return loadAccounts;}()},{key:"loadPieChart",// async loadTotalTRXSupply(){
//     let {intl} = this.props;
...
//     });
// }
value:function(){var _ref4=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee3(){var intl,_ref5,statisticData,pieChartData;return _regenerator2.default.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:intl=this.props.intl;_context3.next=3;return _api.Client.getStatisticData();case 3:_ref5=_context3.sent;statisticData=_ref5.statisticData;pieChartData=[];if(statisticData.length>0){statisticData.map(function(val,i){pieChartData.push({key:i+1,name:val.name?val.name:val.url,volumeValue:intl.formatNumber(val.blockProduced),volumePercentage:intl.formatNumber(val.percentage*100,{maximumFractionDigits:2,minimumFractionDigits:2})+'%'});});}this.setState({pieChart:pieChartData});case 8:case"end":return _context3.stop();}}},_callee3,this);}));function loadPieChart(){return _ref4.apply(this,arguments);}return loadPieChart;}()},{key:"loadVolume",value:function(){var _ref6=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee4(){var intl,volumeData,volumeUSD,volume,higest,lowest,vo,v;return _regenerator2.default.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:intl=this.props.intl;_context4.next=3;return _index2.default.get("https://server.tron.network/api/v2/node/market_data");case 3:volumeData=_context4.sent;volumeUSD=volumeData.data.market_cap_by_available_supply;volume=volumeUSD.map(function(v,i){return{time:v[0],volume_billion:v[1]/Math.pow(10,9),volume_usd:intl.formatNumber(v[1])+' USD',volume_usd_num:v[1]};});this.setState({volumeStats:volume.slice(27,volume.length-1)});higest={date:'',increment:''};lowest={date:'',increment:''};vo=(0,_lodash.cloneDeep)(volume).sort(this.compare('volume_usd_num'));for(v in vo){vo[v]=_extends({date:vo[v].time},vo[v]);}this.setState({summit:{volumeStats_sort:[{date:vo[vo.length-1].time,increment:vo[vo.length-1].volume_usd_num},{date:vo[0].time,increment:vo[0].volume_usd_num}]}});case 12:case"end":return _context4.stop();}}},_callee4,this);}));function loadVolume(){return _ref6.apply(this,arguments);}return loadVolume;}()},{key:"loadPriceStats",value:function(){var _ref7=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee5(){var intl,today,timerToday,birthday,timerBirthday,dayNum,_ref8,data,priceStatsTemp,higest,lowest,pr,p;return _regenerator2.default.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:intl=this.props.intl;today=new Date();timerToday=today.getTime();birthday=new Date("2017/10/10");timerBirthday=birthday.getTime();dayNum=Math.floor((timerToday-timerBirthday)/1000/3600/24);_context5.next=8;return _index2.default.get("https://min-api.cryptocompare.com/data/histoday?fsym=TRX&tsym=USD&limit="+dayNum);case 8:_ref8=_context5.sent;data=_ref8.data;priceStatsTemp=data['Data'];this.setState({priceStats:priceStatsTemp});higest={date:'',increment:''};lowest={date:'',increment:''};pr=(0,_lodash.cloneDeep)(priceStatsTemp).sort(this.compare('close'));for(p in pr){pr[p]=_extends({date:pr[p].time},pr[p]);}this.setState({summit:{priceStats_sort:[{date:pr[pr.length-1].time*1000,increment:pr[pr.length-1].close},{date:pr[0].time*1000,increment:pr[0].close}]}});case 17:case"end":return _context5.stop();}}},_callee5,this);}));function loadPriceStats(){return _ref7.apply(this,arguments);}return loadPriceStats;}()},{key:"loadTxOverviewStats",value:function(){var _ref9=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee6(){var _ref10,txOverviewStats,temp,addressesTemp,blockSizeStatsTemp,blockchainSizeStatsTemp,txs,_tx,compare,higest,lowest,addr,tx,totaltxns,bs,_bcs,b,_b,bcs;return _regenerator2.default.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:compare=function compare(property){return function(obj1,obj2){if(obj1[property]>obj2[property]){return 1;}else if(obj1[property]<obj2[property]){return-1;}else{return 0;}};};_context6.next=3;return _api.Client.getTxOverviewStatsAll();case 3:_ref10=_context6.sent;txOverviewStats=_ref10.txOverviewStats;temp=[];addressesTemp=[];blockSizeStatsTemp=[];blockchainSizeStatsTemp=[];for(txs in txOverviewStats){_tx=parseInt(txs);if(_tx===0){temp.push({avgBlockSize:txOverviewStats[_tx].avgBlockSize,avgBlockTime:txOverviewStats[_tx].avgBlockTime,blockchainSize:txOverviewStats[_tx].blockchainSize,date:txOverviewStats[_tx].date,newAddressSeen:txOverviewStats[_tx].newAddressSeen,newBlockSeen:txOverviewStats[_tx].newBlockSeen,newTransactionSeen:txOverviewStats[_tx].newTransactionSeen,totalAddress:txOverviewStats[_tx].totalAddress,totalBlockCount:txOverviewStats[_tx].totalBlockCount,totalTransaction:txOverviewStats[_tx].totalTransaction,newtotalTransaction:txOverviewStats[_tx].totalTransaction,newtotalAddress:txOverviewStats[_tx].totalAddress,newtotalBlockCount:txOverviewStats[_tx].totalBlockCount});addressesTemp.push({date:txOverviewStats[_tx].date,total:txOverviewStats[_tx].newAddressSeen,increment:txOverviewStats[_tx].newAddressSeen});}else{temp.push({date:txOverviewStats[_tx].date,totalTransaction:txOverviewStats[_tx].totalTransaction-txOverviewStats[_tx-1].totalTransaction,avgBlockTime:txOverviewStats[_tx].avgBlockTime,avgBlockSize:txOverviewStats[_tx].avgBlockSize,totalBlockCount:txOverviewStats[_tx].totalBlockCount-txOverviewStats[_tx-1].totalBlockCount,newAddressSeen:txOverviewStats[_tx].newAddressSeen,newtotalTransaction:txOverviewStats[_tx].totalTransaction,newtotalAddress:txOverviewStats[_tx].totalAddress,newtotalBlockCount:txOverviewStats[_tx].totalBlockCount});addressesTemp.push({date:txOverviewStats[_tx].date,total:txOverviewStats[_tx].totalAddress,increment:txOverviewStats[_tx].newAddressSeen});}blockSizeStatsTemp.push({date:txOverviewStats[_tx].date,avgBlockSize:txOverviewStats[_tx].avgBlockSize});blockchainSizeStatsTemp.push({date:txOverviewStats[_tx].date,blockchainSize:txOverviewStats[_tx].blockchainSize});}this.setState({txOverviewStats:temp.slice(0,temp.length-1),txOverviewStatsFull:temp.slice(0,temp.length),addressesStats:addressesTemp.slice(0,addressesTemp.length-1),blockSizeStats:blockSizeStatsTemp,blockchainSizeStats:blockchainSizeStatsTemp});higest={date:'',increment:''};lowest={date:'',increment:''};addr=(0,_lodash.cloneDeep)(addressesTemp).sort(compare('increment'));tx=(0,_lodash.cloneDeep)(temp).sort(compare('totalTransaction'));totaltxns=(0,_lodash.cloneDeep)(temp).sort(compare('newtotalTransaction'));bs=(0,_lodash.cloneDeep)(blockSizeStatsTemp).sort(compare('avgBlockSize'));_bcs=[];for(b in blockchainSizeStatsTemp){_b=parseInt(b);if(_b===0){_bcs.push({date:blockchainSizeStatsTemp[0].date,blockchainSize:blockchainSizeStatsTemp[0].blockchainSize/1000000});}else{_bcs.push({date:blockchainSizeStatsTemp[_b].date,blockchainSize:(blockchainSizeStatsTemp[_b].blockchainSize-blockchainSizeStatsTemp[_b-1].blockchainSize)/1000000});}}bcs=_bcs.sort(compare('blockchainSize'));this.setState({summit:{addressesStats_sort:[{date:addr[addr.length-1].date,increment:addr[addr.length-1].increment},{date:addr[0].date,increment:addr[0].increment}],txOverviewStats_sort:[{date:tx[tx.length-1].date,increment:tx[tx.length-1].totalTransaction},{date:tx[0].date,increment:tx[0].totalTransaction}],totalTxns_sort:[{date:totaltxns[totaltxns.length-1].date,increment:totaltxns[totaltxns.length-1].newtotalTransaction},{date:totaltxns[0].date,increment:totaltxns[0].newtotalTransaction}],blockSizeStats_sort:[{date:bs[bs.length-1].date,increment:bs[bs.length-1].avgBlockSize},{date:bs[0].date,increment:bs[0].avgBlockSize}],blockchainSizeStats_sort:[{date:bcs[bcs.length-1].date,increment:bcs[bcs.length-1].blockchainSize},{date:bcs[0].date,increment:bcs[0].blockchainSize}]}});case 21:case"end":return _context6.stop();}}},_callee6,this);}));function loadTxOverviewStats(){return _ref9.apply(this,arguments);}return loadTxOverviewStats;}()// 获取TRON日能量消耗图表
},{key:"loadEnergyConsumeData",value:function(){var _ref11=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee7(){var _ref12,data;return _regenerator2.default.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:_context7.next=2;return _index2.default.get(_constants.API_URL+"/api/energystatistic");case 2:_ref12=_context7.sent;data=_ref12.data;data.data.pop();this.setState({energyConsumeData:data.data,summit:{EnergyConsume_sort:[{date:data.max.day,increment:data.max.total_energy},{date:data.min.day,increment:data.min.total_energy}]}});case 6:case"end":return _context7.stop();}}},_callee7,this);}));function loadEnergyConsumeData(){return _ref11.apply(this,arguments);}return loadEnergyConsumeData;}()// TRON日合约调用图表
},{key:"loadContractInvocation",value:function(){var _ref13=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee8(){var _ref14,data,_ref15,addressData,payload;return _regenerator2.default.wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:_context8.next=2;return _index2.default.get(_constants.API_URL+"/api/triggerstatistic");case 2:_ref14=_context8.sent;data=_ref14.data;_context8.next=6;return _index2.default.get(_constants.API_URL+"/api/calleraddressstatistic");case 6:_ref15=_context8.sent;addressData=_ref15.data;data.data.pop();addressData.data.pop();payload={trigger_amount:[],address_amount:[]};data.data.map(function(item){payload.trigger_amount.push([(0,_moment2.default)(item.day).valueOf(),item.triggers_amount]);});addressData.data.map(function(item){payload.address_amount.push([(0,_moment2.default)(item.day).valueOf(),item.caller_amount]);});this.setState({ContractInvocation:payload,summit:{ContractInvocation_sort:[{date:data.max.day,increment:data.max.triggers_amount},{date:data.min.day,increment:data.min.triggers_amount}]}});case 14:case"end":return _context8.stop();}}},_callee8,this);}));function loadContractInvocation(){return _ref13.apply(this,arguments);}return loadContractInvocation;}()// 每日合约消耗能量分布
},{key:"loadEnergyConsumeDistribution",value:function(){var _ref16=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee9(){var _state$ContractInvoca,time,range,_ref17,_ref17$data,total,totalEnergy,data,totle_used_energy,used_scale;return _regenerator2.default.wrap(function _callee9$(_context9){while(1){switch(_context9.prev=_context9.next){case 0:_state$ContractInvoca=this.state.ContractInvocationDistributionParams,time=_state$ContractInvoca.time,range=_state$ContractInvoca.range;_context9.next=3;return _index2.default.get(_constants.API_URL+"/api/energydailystatistic?limit="+range+"&day="+time);case 3:_ref17=_context9.sent;_ref17$data=_ref17.data;total=_ref17$data.total;totalEnergy=_ref17$data.totalEnergy;data=_ref17$data.data;totle_used_energy=0;used_scale='';data.map(function(item,index){item.percent=(item.total_energy/totalEnergy*100).toFixed(2)+'%';item.index=index+1;item.name=item.name||'-';totle_used_energy+=item.total_energy;});used_scale=(totle_used_energy/totalEnergy*100).toFixed(2)+'%';this.setState({EnergyConsumeDistribution:data,ContractInvocationDistributionParams:_extends({},this.state.ContractInvocationDistributionParams,{total_used_energy:totle_used_energy,scale:used_scale,total_energy:totalEnergy})});case 13:case"end":return _context9.stop();}}},_callee9,this);}));function loadEnergyConsumeDistribution(){return _ref16.apply(this,arguments);}return loadEnergyConsumeDistribution;}()},{key:"loadContractInvocationDistribution",value:function(){var _ref18=_asyncToGenerator(/*#__PURE__*/_regenerator2.default.mark(function _callee10(){var _state$ContractInvoca2,time,range,_ref19,_ref19$data,data,totalCallerAmount,totalTrigger,totle_used_energy,used_scale;return _regenerator2.default.wrap(function _callee10$(_context10){while(1){switch(_context10.prev=_context10.next){case 0:_state$ContractInvoca2=this.state.ContractInvocationDistributionParams,time=_state$ContractInvoca2.time,range=_state$ContractInvoca2.range;_context10.next=3;return _index2.default.get(_constants.API_URL+"/api/triggeramountstatistic?limit="+range+"&day="+time);case 3:_ref19=_context10.sent;_ref19$data=_ref19.data;data=_ref19$data.data;totalCallerAmount=_ref19$data.totalCallerAmount;totalTrigger=_ref19$data.totalTrigger;// let {data: callData} = await xhr.get(API_URL + "/api/calleraddressamountstatistic?limit="+ range+"&long="+time);
totle_used_energy=0;used_scale='';data.map(function(item,index){item.caller_percent=(item.caller_amount/totalCallerAmount).toFixed(2)+'%';item.trigger_percent=(item.trigger_amount/totalTrigger).toFixed(2)+'%';item.index=index+1;item.name=item.name||'-';});used_scale=(totle_used_energy/data.totalTrigger).toFixed(2)+'%';this.setState({ContractInvocationDistribution:data,ContractInvocationDistributionParams:_extends({},this.state.ContractInvocationDistributionParams,{total_energy:totalTrigger})});case 13:case"end":return _context10.stop();}}},_callee10,this);}));function loadContractInvocationDistribution(){return _ref18.apply(this,arguments);}return loadContractInvocationDistribution;}()},{key:"render",value:function render(){var _props=this.props,match=_props.match,intl=_props.intl;var _state=this.state,txOverviewStats=_state.txOverviewStats,txOverviewStatsFull=_state.txOverviewStatsFull,addressesStats=_state.addressesStats,blockSizeStats=_state.blockSizeStats,blockchainSizeStats=_state.blockchainSizeStats,priceStats=_state.priceStats,transactionStats=_state.transactionStats,transactionValueStats=_state.transactionValueStats,blockStats=_state.blockStats,accounts=_state.accounts,volumeStats=_state.volumeStats,pieChart=_state.pieChart,supplyTypesChart=_state.supplyTypesChart,summit=_state.summit,genesisNum=_state.genesisNum,blockProduceRewardsNum=_state.blockProduceRewardsNum,nodeRewardsNum=_state.nodeRewardsNum,independenceDayBurned=_state.independenceDayBurned,feeBurnedNum=_state.feeBurnedNum,currentTotalSupply=_state.currentTotalSupply,priceUSD=_state.priceUSD,priceBTC=_state.priceBTC,marketCapitalization=_state.marketCapitalization,foundationFreeze=_state.foundationFreeze,circulatingNum=_state.circulatingNum,energyConsumeData=_state.energyConsumeData,ContractInvocation=_state.ContractInvocation,ContractInvocationDistribution=_state.ContractInvocationDistribution,ContractInvocationDistributionParams=_state.ContractInvocationDistributionParams,EnergyConsumeDistribution=_state.EnergyConsumeDistribution;var unit=void 0;var uploadURL=_constants.API_URL+"/api/v2/node/overview_upload";var column=this.customizedColumn();var call_colum=this.callCustomizedColumn();var chartHeight=_isMobile2.default?240:500;if(match.params.chartName==='blockchainSizeStats'||match.params.chartName==='addressesStats'){unit='increase';}else{unit='number';}return _react2.default.createElement("main",{className:"container header-overlap"},match.params.chartName!='pieChart'&&match.params.chartName!='supply'&&match.params.chartName!='ContractInvocationDistribution'&&match.params.chartName!='EnergyConsumeDistribution'?_react2.default.createElement("div",{className:"alert alert-light",role:"alert"},_react2.default.createElement("div",{className:"row"},_react2.default.createElement("div",{className:"col-md-6 text-center"},summit&&summit[match.params.chartName+'_sort']&&_react2.default.createElement("span",null,(0,_i18n.t)('highest'),(0,_i18n.t)(unit),(0,_i18n.t)('_of'),_react2.default.createElement("strong",null,' '+summit[match.params.chartName+'_sort'][0].increment+' '),(0,_i18n.t)('was_recorded_on')," ",intl.formatDate(summit[match.params.chartName+'_sort'][0].date))),_react2.default.createElement("div",{className:"col-md-6 text-center"},summit&&summit[match.params.chartName+'_sort']&&_react2.default.createElement("span",null,(0,_i18n.t)('lowest'),(0,_i18n.t)(unit),(0,_i18n.t)('_of'),_react2.default.createElement("strong",null,' '+summit[match.params.chartName+'_sort'][1].increment+' '),(0,_i18n.t)('was_recorded_on')," ",intl.formatDate(summit[match.params.chartName+'_sort'][1].date))))):null,_react2.default.createElement("div",{className:"row"},_react2.default.createElement("div",{className:"col-md-12"},_react2.default.createElement("div",{className:"card"},_react2.default.createElement("div",{className:"card-body p-3 p-md-5"},match.params.chartName==='txOverviewStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},txOverviewStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartTx,{source:"singleChart",style:{height:chartHeight},data:txOverviewStats,intl:intl})),match.params.chartName==='totalTxns'&&_react2.default.createElement("div",{style:{height:chartHeight}},txOverviewStatsFull===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartTotalTxns,{source:"singleChart",style:{height:chartHeight},data:txOverviewStatsFull,intl:intl})),match.params.chartName==='addressesStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},addressesStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartAdd,{source:"singleChart",style:{height:chartHeight},data:addressesStats,intl:intl})),match.params.chartName==='blockSizeStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},blockSizeStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.BarReactHighChartBlockSize,{source:"singleChart",style:{height:chartHeight},data:blockSizeStats,intl:intl})),match.params.chartName==='blockchainSizeStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},blockchainSizeStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartBlockchainSize,{source:"singleChart",style:{height:chartHeight},data:blockchainSizeStats,intl:intl})),match.params.chartName==='priceStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},priceStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartPrice,{source:"singleChart",style:{height:chartHeight},data:priceStats,intl:intl})),match.params.chartName==='accounts'&&_react2.default.createElement("div",{style:{height:chartHeight}},accounts===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_PieChart2.default,{style:{height:chartHeight},data:accounts})),match.params.chartName==='transactionValueStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},transactionValueStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineChart2.default,{message:{id:'trx_transferred_past_hour',href:'transactionValueStats'},style:{height:chartHeight},data:transactionValueStats,keysData:['timestamp','value'],format:{timestamp:true}})),match.params.chartName==='transactionStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},transactionStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineChart2.default,{message:{id:'transactions_past_hour',href:'transactionStats'},style:{height:chartHeight},data:transactionStats,keysData:['timestamp','value'],format:{timestamp:true}})),match.params.chartName==='blockStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},blockStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineChart2.default,{message:{id:'average_blocksize',href:'blockStats'},style:{height:chartHeight},data:blockStats,keysData:['timestamp','value'],format:{timestamp:true}})),match.params.chartName==='volumeStats'&&_react2.default.createElement("div",{style:{height:chartHeight}},volumeStats===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.LineReactHighChartVolumeUsd,{style:{height:chartHeight},data:volumeStats,intl:intl})),match.params.chartName==='EnergyConsume'&&_react2.default.createElement("div",{style:{height:chartHeight}},energyConsumeData===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.EnergyConsumeChart,{source:"singleChart",style:{height:chartHeight},data:energyConsumeData,type:"c2",intl:intl})),match.params.chartName==='ContractInvocation'&&_react2.default.createElement("div",{style:{height:chartHeight}},ContractInvocation===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_LineCharts.ContractInvocationChart,{source:"singleChart",style:{height:chartHeight},data:ContractInvocation,intl:intl})),//    EnergyConsumeDistribution
match.params.chartName==='EnergyConsumeDistribution'&&_react2.default.createElement("div",null,EnergyConsumeDistribution===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement("div",null,_react2.default.createElement("div",{className:"d-md-flex justify-content-between pb-3"},_react2.default.createElement(_datePicker2.default,{onChange:this.onChangeDate,disabledDate:this.disabledEndDate,defaultValue:(0,_moment2.default)(new Date(ContractInvocationDistributionParams.time),'YYYY-MM-DD')}),_react2.default.createElement("div",{className:"pt-3 pt-md-0"},_react2.default.createElement("span",{className:"mr-2"},(0,_i18n.tu)('range'),": "),_react2.default.createElement(_select2.default,{defaultValue:"top20",style:{width:160},onChange:this.handleChangeSelect},_react2.default.createElement(Option,{value:"20"},"top20"),_react2.default.createElement(Option,{value:"50"},"top50"),_react2.default.createElement(Option,{value:"100"},"top100")))),_react2.default.createElement(_LineCharts.EnergyConsumeDistributionChart,{style:{height:chartHeight},data:EnergyConsumeDistribution,intl:intl}),_react2.default.createElement("div",{className:"token_black"},_react2.default.createElement("div",{className:"col-md-12 table_pos"},_react2.default.createElement("p",null,intl.formatMessage({id:'a_total'})+intl.formatNumber(ContractInvocationDistributionParams.total_energy)+intl.formatMessage({id:'energe'})+' ('+intl.formatMessage({id:'with_the_proportion_of'})+ContractInvocationDistributionParams.scale+') '+intl.formatMessage({id:'uesd_by_the'})+ContractInvocationDistributionParams.range_type+intl.formatMessage({id:'contracts_from_the_total_used_of'})+intl.formatNumber(ContractInvocationDistributionParams.total_used_energy)+intl.formatMessage({id:'energe'})),EnergyConsumeDistribution.length===0?_react2.default.createElement("div",{className:"p-3 text-center no-data"},(0,_i18n.tu)("no_data")):_react2.default.createElement(_SmartTable2.default,{bordered:true,column:column,data:EnergyConsumeDistribution}))))),match.params.chartName==='ContractInvocationDistribution'&&_react2.default.createElement("div",null,ContractInvocationDistribution===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement("div",null,_react2.default.createElement("div",{className:"d-md-flex justify-content-between pb-3"},_react2.default.createElement(_datePicker2.default,{onChange:this.onChangeDate,disabledDate:this.disabledEndDate,defaultValue:(0,_moment2.default)(new Date(ContractInvocationDistributionParams.time),'YYYY-MM-DD')}),_react2.default.createElement("div",{className:"pt-3 pt-md-0"},_react2.default.createElement("span",{className:"mr-2"},(0,_i18n.tu)('range'),": "),_react2.default.createElement(_select2.default,{defaultValue:"top20",style:{width:160},onChange:this.handleChangeSelect},_react2.default.createElement(Option,{value:"20"},"top20"),_react2.default.createElement(Option,{value:"50"},"top50"),_react2.default.createElement(Option,{value:"100"},"top100")))),_react2.default.createElement(_LineCharts.ContractInvocationDistributionChart,{style:{height:chartHeight},data:ContractInvocationDistribution,intl:intl}),_react2.default.createElement("div",{className:"token_black"},_react2.default.createElement("div",{className:"col-md-12 table_pos"},_react2.default.createElement("p",null,intl.formatMessage({id:'a_total'})+intl.formatNumber(ContractInvocationDistributionParams.total_energy)+intl.formatMessage({id:'Contract_times_calls'})),ContractInvocationDistribution.length===0?_react2.default.createElement("div",{className:"p-3 text-center no-data"},(0,_i18n.tu)("no_data")):_react2.default.createElement(_SmartTable2.default,{bordered:true,column:call_colum,data:ContractInvocationDistribution}))))),match.params.chartName==='pieChart'&&_react2.default.createElement("div",null,pieChart===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement(_RingPieChart.RepresentativesRingPieReact,{source:"singleChart",message:{id:'produce_distribution'},intl:intl,data:pieChart,style:{height:chartHeight}})),match.params.chartName==='supply'&&_react2.default.createElement("div",null,supplyTypesChart===null?_react2.default.createElement(_loaders.TronLoader,null):_react2.default.createElement("div",{className:"row",style:{fontSize:12,marginRight:0}},_react2.default.createElement("div",{className:"col-md-5"},_react2.default.createElement("div",{className:"table-responsive"},_react2.default.createElement("table",{className:"table",style:{marginTop:10}},_react2.default.createElement("thead",null,_react2.default.createElement("tr",null,_react2.default.createElement("th",{style:{border:0}},_react2.default.createElement("i",{className:"fa fa-puzzle-piece"}),_react2.default.createElement("span",{style:{marginTop:2}},(0,_i18n.tu)('TRX_distribution_overview'))))),_react2.default.createElement("tbody",null,_react2.default.createElement("tr",null,_react2.default.createElement("td",null,(0,_i18n.tu)('genesis'),":"),_react2.default.createElement("td",null,genesisNum," TRX")),_react2.default.createElement("tr",null,_react2.default.createElement("td",null,"+  ",(0,_i18n.tu)('block_produce_rewards'),":"),_react2.default.createElement("td",null,blockProduceRewardsNum," TRX")),_react2.default.createElement("tr",null,_react2.default.createElement("td",null,"+ ",(0,_i18n.tu)('node_rewards'),":"),_react2.default.createElement("td",null,nodeRewardsNum," TRX")),_react2.default.createElement("tr",null,_react2.default.createElement("td",null,"- ",(0,_i18n.tu)('independence_day_burned'),":"),_react2.default.createElement("td",null,independenceDayBurned," TRX")),_react2.default.createElement("tr",null,_react2.default.createElement("td",null,"- ",(0,_i18n.tu)('fee_burned'),":"),_react2.default.createElement("td",null,feeBurnedNum," TRX")),_react2.default.createElement("tr",null,_react2.default.createElement("td",null,"= ",_react2.default.createElement("b",null,(0,_i18n.tu)('current_total_supply'),":"),_react2.default.createElement("br",null)),_react2.default.createElement("td",null,_react2.default.createElement("b",null,intl.formatNumber(currentTotalSupply)," TRX"))),_react2.default.createElement("tr",null,_react2.default.createElement("td",{style:{color:'red'},className:"go-foundation"},_react2.default.createElement(_reactRouterDom.Link,{to:"/blockchain/foundation",style:{color:'red'}},(0,_i18n.tu)("total_frozen"))),_react2.default.createElement("td",null,foundationFreeze," TRX")),_react2.default.createElement("tr",null,_react2.default.createElement("td",null,(0,_i18n.tu)('circulating_supply'),":"),_react2.default.createElement("td",null,circulatingNum," TRX"))))),_react2.default.createElement("br",null),_react2.default.createElement("div",{className:"table-responsive"},_react2.default.createElement("table",{className:"table",style:{marginBottom:0}},_react2.default.createElement("thead",null,_react2.default.createElement("tr",null,_react2.default.createElement("th",{style:{border:0}},_react2.default.createElement("br",null),_react2.default.createElement("i",{className:"fa fa-coins"})," ",(0,_i18n.tu)('price_per_1000_trx')))),_react2.default.createElement("tbody",null,_react2.default.createElement("tr",null,_react2.default.createElement("td",null,(0,_i18n.tu)('in_USD'),":"),_react2.default.createElement("td",null,"$",priceUSD)),_react2.default.createElement("tr",null,_react2.default.createElement("td",null,(0,_i18n.tu)('in_BTC'),":"),_react2.default.createElement("td",null,priceBTC)))),_react2.default.createElement("div",{style:{fontSize:12,color:'#999',whiteSpace:'nowrap',textAlign:'left',padding:'0.75rem',borderTop:'1px solid #DFD7CA',verticalAlign:'top'}},_react2.default.createElement("div",{style:{transform:'scale(.9)',marginLeft:'-1.3rem'}},"*",(0,_i18n.tu)('supply_notes'))))),_react2.default.createElement("div",{className:"col-md-7",style:{backgroundColor:'#F5F5F5',marginTop:0,paddingBottom:15}},_react2.default.createElement("div",{className:"main-counters row"},_react2.default.createElement("div",{className:"counters col-md-6 col-sm-6"},_react2.default.createElement("span",{className:"counter"},_react2.default.createElement(_reactCountup2.default,{start:0,end:currentTotalSupply,duration:2,separator:",",decimals:2})),_react2.default.createElement("h4",null,(0,_i18n.tu)('total_TRX_supply'))),_react2.default.createElement("div",{className:"counters col-md-6 col-sm-6"},_react2.default.createElement("span",{className:"counter"},"$",_react2.default.createElement(_reactCountup2.default,{start:0,end:marketCapitalization,duration:2,separator:",",decimals:2})),_react2.default.createElement("h4",null,(0,_i18n.tu)('market_capitalization')))),_react2.default.createElement("div",{className:"card"},_react2.default.createElement("div",{className:"card-body",style:{height:400}},_react2.default.createElement(_RingPieChart.SupplyTypesTRXPieChart,{message:{id:'breakdown_supply_types'},intl:intl,data:supplyTypesChart,style:{height:300,marginTop:25},source:"singleChart"})))))))),match.params.chartName==='txOverviewStats'&&_react2.default.createElement("div",{style:{marginTop:20,float:'right'}},_react2.default.createElement("i",{size:"1",style:{fontStyle:'normal'}},"[ Download ",_react2.default.createElement("a",{href:uploadURL,style:{color:'#C23631'}},_react2.default.createElement("b",null,"CSV Export")),"\xA0",_react2.default.createElement("span",{className:"glyphicon glyphicon-download-alt"})," ]"),"\xA0"))));}}]);return Statistics;}(_react2.default.Component);function mapStateToProps(state){return{priceGraph:state.markets.price};}var mapDispatchToProps={loadPriceData:_markets.loadPriceData};exports.default=(0,_reactRedux.connect)(mapStateToProps,mapDispatchToProps)((0,_reactIntl.injectIntl)(Statistics));
...
var echarts = __webpack_require__(31);

var zrUtil = __webpack_require__(3);

var Model = __webpack_require__(90);
...
var graphic = __webpack_require__(38);

var _listComponent = __webpack_require__(1032);

var makeBackground = _listComponent.makeBackground;

var layoutUtil = __webpack_require__(97);
...
var legendFilter = __webpack_require__(2453);
...
var LegendModel = __webpack_require__(2396);
...
var LegendView = __webpack_require__(2397);
...
//# sourceMappingURL=SingleStats.3dccb3d3.chunk.js.map